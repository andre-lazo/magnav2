...
<b>Fecha:</b> {{$campos->start}}
        ...
        <p class="centrado25 text-justify">Yo, {{$campos->usuario}} propietario(a) de la villa asignada con el 
No.……..de la manzana ……de ésta Urbanización, solicito se digne autorizar el uso de la siguiente área comunitaria..................................................
para el {{$campos->start}} en el horario de {{$campos->hora}} , para la distracción propia y de mi familia.<br><br>  </p>
...
<tr >
<td align="center" width="360" height="25"> {{$campos->visi1}} </td>
<td align="center"  width="240" height="25"> {{$campos->pare1}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$campos->visi2}} </td>
<td align="center"  width="240" height="25"> {{$campos->pare2}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$campos->visi3}}  </td>
<td align="center"  width="240" height="25"> {{$campos->pare3}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$campos->visi4}}  </td>
<td align="center"  width="240" height="25"> {{$campos->pare4}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$campos->visi5}} </td>
<td align="center"  width="240" height="25"> {{$campos->pare5}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$campos->visi6}} </td>
<td align="center"  width="240" height="25"> {{$campos->pare6}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$campos->visi7}} </td>
<td align="center"  width="240" height="25"> {{$campos->pare7}} </td>
</tr>
...
<br><br> Atentamente. <br><br> <b>Firma:</b> Confirmación Electrónica.<br><b> Nombres: {{$campos->usuario}} </b><br> <b>Número C.C.:</b> </p>
