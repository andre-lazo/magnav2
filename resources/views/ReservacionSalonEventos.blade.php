...
<b>Fecha:</b> {{$eventos->start}}
        ...
        <p class="centrado25 text-justify">Yo, {{$eventos->usuario}} propietario(a) de la villa asignada con el 
No.……..de la manzana ……de ésta Urbanización, solicito se digne autorizar el uso de la siguiente área comunitaria..................................................
para el {{$eventos->start}} en el horario de {{$eventos->hora}} , para la distracción propia y de mi familia.<br><br>  </p>
...
<tr >
<td align="center" width="360" height="25"> {{$eventos->visi1}} </td>
<td align="center"  width="240" height="25"> {{$eventos->pare1}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$eventos->visi2}} </td>
<td align="center"  width="240" height="25"> {{$eventos->pare2}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$eventos->visi3}}  </td>
<td align="center"  width="240" height="25"> {{$eventos->pare3}} </td>
</tr>
<tr >
<td align="center" width="360" height="25"> {{$eventos->visi4}}  </td>
<td align="center"  width="240" height="25"> {{$eventos->pare4}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$eventos->visi5}} </td>
<td align="center"  width="240" height="25"> {{$eventos->pare5}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$eventos->visi6}} </td>
<td align="center"  width="240" height="25"> {{$eventos->pare6}} </td>
</tr>
<tr >
<td align="center" width="360" height="25">  {{$eventos->visi7}} </td>
<td align="center"  width="240" height="25"> {{$eventos->par7}} </td>
</tr>
...
<br><br> Atentamente. <br><br> <b>Firma:</b> Confirmación Electrónica.<br><b> Nombres: {{$eventos->usuario}} </b><br> <b>Número C.C.:</b> </p>
